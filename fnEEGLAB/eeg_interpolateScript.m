function [EEG] = eeg_interpolateScript(EEG, wkdir, Electrode2Interpolate)
...
if nargin < 3; Electrode2Interpolate = [];end

if isempty(Electrode2Interpolate) && isfield(EEG.etc,'chans4intpol')
    Electrode2Interpolate = EEG.etc.chans4intpol;
end

if ~isempty(Electrode2Interpolate)
